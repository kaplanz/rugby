        ...
        <sl-tab-group>
          ...
          <sl-tab-panel name="usage">
            <article>
              <h3>Controls</h3>
              <p>
                Controls should be fairly self-explanatory, with buttons
                corresponding to their emulator inputs. You can also toggle
                power by clicking "OFF &bullet; ON" in the frame.
              </p>
              <h3>Bindings</h3>
              <p>
              ...
              <p>
                There are also key bindings for the web application:
              </p>
              <table>
                <thead>
                ...
                <tbody>
                  <tr><td>?</td><td>Show menu</td></tr>
                  <tr><td>Escape</td><td>Hide menu</td></tr>
                  <tr><td>Number</td><td>Go to tab</td></tr>
                </tbody>
              </table>
              <p>
                You can also toggle this menu by pressing the (&#x2139;&#xfe0e;)
                button.
              </p>
            </article>
          </sl-tab-panel>
          ...
          <sl-tab-panel name="settings">
            <!-- Running -->
            <sl-switch
              help-text="When disabled, the emulator will be paused."
              ?checked=${this.app.cfg.run}
              @sl-change=${this.configure.run.bind(this)}
            >Running</sl-switch>
            <!-- Speed -->
            <sl-range
              label="Speed"
              ...
              @sl-change=${this.configure.spd.bind(this)}
              help-text="Controls the simulated clock speed of the emulator."
            ></sl-range>
          </sl-tab-panel>
        </sl-tab-group>
      </sl-dialog>
  ...
  static styles = [css`
    ...
    sl-tab-panel {
      ...
      &[name="about"] {
        ...
        > footer {
          border-top: 1px solid hsl(240, 4.6%, 22%);
          margin-top: .5em;
          padding-top: 1em;
