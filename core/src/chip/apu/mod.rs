...
/// channel's features should be clocked.
///
/// It is driven by the [timer](super::tma), specifically the falling edge of
/// the [divider register](tma::reg::Div)'s bit 4.
#[derive(Debug)]
pub struct Sequencer {
    ...
    /// Clock driver.
    ///
    /// Uses `DIV[4]` from the [timer](super::tma).
